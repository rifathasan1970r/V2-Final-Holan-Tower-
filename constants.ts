...
export const VIEW_TO_PATH: Record<string, string> = {
  ...
  SERVICE_CHARGE_MONTHLY_SUMMARY_2025: '/service-charge.html?section=monthly-summary&year=2025',
  SERVICE_CHARGE_MONTHLY_SUMMARY_2026: '/service-charge.html?section=monthly-summary&year=2026',
  SERVICE_CHARGE_DUE_SUMMARY: '/service-charge.html?section=due-summary',
  SERVICE_CHARGE_FULL_YEAR_2025: '/service-charge.html?section=full-year-table&year=2025',
  SERVICE_CHARGE_FULL_YEAR_2026: '/service-charge.html?section=full-year-table&year=2026',
  SERVICE_CHARGE_PARKING_SELECT: '/service-charge.html?section=parking-charge&mode=select',
  SERVICE_CHARGE_PARKING_ONLY: '/service-charge.html?section=parking-charge&mode=parking',
  SERVICE_CHARGE_PARKING_MONTHLY_2025: '/service-charge.html?section=parking-monthly-summary&year=2025',
  SERVICE_CHARGE_PARKING_MONTHLY_2026: '/service-charge.html?section=parking-monthly-summary&year=2026',
  SERVICE_CHARGE_PARKING_DUE: '/service-charge.html?section=parking-due-summary',
  SERVICE_CHARGE_PARKING_FULL_YEAR_2025: '/service-charge.html?section=parking-full-year-table&year=2025',
  SERVICE_CHARGE_PARKING_FULL_YEAR_2026: '/service-charge.html?section=parking-full-year-table&year=2026',
